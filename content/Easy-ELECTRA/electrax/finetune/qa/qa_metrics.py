...
from electrax.finetune import scorer
from electrax.finetune.qa import mrqa_official_eval
from electrax.finetune.qa import squad_official_eval
from electrax.finetune.qa import squad_official_eval_v1
...
class SpanBasedQAScorer(scorer.Scorer):
    ...
    def __init__(self, config: FinetuningConfig, task, split,
                 v2):
    ...
    def _get_results(self):
        ...
        if self._name == "squad":
            ...
            return sorted(tfutils.load_json(
    ...
    def write_predictions(self):
        ...
        tfutils.write_json(dict(all_predictions),
...
def get_final_text(config: FinetuningConfig, pred_text,
                   orig_text):
