...
from electrax.finetune import feature_spec
from electrax.finetune import task
from electrax.finetune.tagging import tagging_metrics
from electrax.finetune.tagging import tagging_utils
...
class TaggingTask(task.Task):
    ...
    def _get_label_mapping(self, provided_split=None, provided_sentences=None):
        ...
        if tf.io.gfile.exists(self._label_mapping_path):
            self._label_mapping = tfutils.load_pickle(self._label_mapping_path)
            return self._label_mapping
        ...
        tfutils.write_pickle(label_mapping, self._label_mapping_path)
